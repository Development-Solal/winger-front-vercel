...
import {ArrowUp, Cake, Info, Mail, MapPin, UserRound, UserRoundPlus} from "lucide-react";
...
import {DeactivateAidantService, UpdateAidantService} from "@/services/AidantService";
...
const Aidant = () => {
    ...
    function onSubmit(values: z.infer<typeof formSchema>) {
        ...
        if (user) {
            UpdateAidantService(user?.id, formData)
                .then(res => {
                    console.log(res);
                    setErrorMsg("");
                    setIsLoading(false);
                ...
                <div className="grid grid-cols-1 md:grid-cols-[300px,1fr] gap-8">
                    ...
                    <div
                        ...
                        <div className="rounded-md bg-white p-6 sm:p-8 shadow-lg mt-8 w-full max-w-full">
                            ...
                            <h2 className="mb-6 text-center text-2xl font-bold text-dark-blue">Profil
                                de {user?.first_name}</h2>
                                ...
                                <form
                                                        ...
                                                        <Select onValueChange={field.onChange}
                                                            ...
                                                            <FormControl>
                                                                <SelectTrigger
                                                                    ...
                                                                    />
                                                                    <SelectValue
                                                                        placeholder={t("forms.age_aidant") + "*"}/>
                                                                </SelectTrigger>
                                                            </FormControl>
                                                            <SelectContent>
                                                ...
                                                <Tooltip delayDuration={100}>
                                                    ...
                                                    <TooltipContent
                                                        ...
                                                        <ul className="space-y-1.5 list-disc list-inside text-left leading-relaxed">
                                                            <li>Votre compte sera supprimé et vous ne pourrez plus vous
                                                                connecter sur WINGer
                                                            </li>
                                                            <li>Vous devrez recréer un nouveau compte <span
                                                                className="font-bold"> avec une nouvelle adresse email</span>
                                                            </li>
                                                            <li>Vos données seront conservées par WINGer le temps
                                                                nécessaire
                                                            </li>
                                                            <li>Vos crédits seront perdus et ne seront pas remboursés
                                                            </li>
                                                            <li>Si vous avez un abonnement en cours, il ne sera pas
                                                                remboursé
                                                            </li>
                                                            <li>Vous devrez supprimer votre paiement automatique dans
                                                                votre compte PayPal sous le nom
                                                                "WINGer"
                                                            </li>
                                                        </ul>
                                                    </TooltipContent>
                                    ...
                                    <div className="mt-6 pt-4 border-t border-gray-200">
                                        <p className="text-xs text-gray-600 leading-relaxed">
                                            * Si vous désirez supprimer définitivement votre compte, merci d'envoyer un
                                            email à{" "}
                                            <a
                                            ...
                                            {" "}en précisant votre nom, prénom et numéro de profil
                                            ({aidantData?.profile_number || "N/A"}).
                                            Vous êtes informé que WINGer se réserve le droit de vérifier l'identité du
                                            demandeur.
