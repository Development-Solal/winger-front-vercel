...
const EditAdminFutureMoitie = () => {
  ...
  useEffect(() => {
    if (FmData) {
      ...
      form.setValue("FMlanguage", languageIds); // ⬅️ Set raw values
            ...
            <div
              ...
              <div className="rounded-md bg-white p-6 sm:p-8 shadow-lg mt-8 w-full max-w-full">
                <Button
                  ...
                  onClick={e => {
                    e.preventDefault();
                    navigate(`/admin/editAdminAide/${aide}`);
                  }}>
                  {t("buttons.aide")}
                </Button>
                          ...
                          <div className="flex items-center">
                            <div className="relative flex-1">
                              <CustomSelectMulti
                                ...
                                value={
                                  field.value
                                    ? townList.filter(option => field["value"]?.includes(option["value"]))
                                    : []
                                }
                                onChange={selected =>
                                  field.onChange(selected?.map((item: {value: string}) => item.value))
...
export default EditAdminFutureMoitie;
